...
<div class="center">
    <form:form action="profile-modify-action" class="form-user-profile" id="update-form" method="post"
               modelAttribute="user">
        <h1>User Profile</h1>
...
<script src="<c:url value="/resources/static/js/ModifyValidate.js"/>"></script>
