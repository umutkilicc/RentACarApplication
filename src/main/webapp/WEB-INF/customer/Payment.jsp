...
<div class="form-container">
    <form:form action="payment-action" id="payment-form" method="GET">
        <div>
            <h1 class="payment-form-title">${car.title}</h1>
            <p class="payment-description">${car.description}</p>
            <h3 class="payment-price">
                Price: <span id="price" class="white-back-text">${car.price}TL</span>
            </h3>
        </div>
        <div class="currency-text">
            <h3 class="">Pay with:
                <a id="tl" class="white-back-text">TL</a>
        ...
        <div>
            ...
            <table class="payment-table">
                ...
                <tr>
                    ...
                    <td><input autofocus id="card-number" name="cardNumber" placeholder="0000 0000 0000 0000"
                               type="text"></td>
                </tr>
                <tr>
